  ...
  return (
    ...
    <div className='flex flex-col  justify-center items-center flex-nowrap gap-5 md:flex-row p-5 '>
        ...
        <div className='bg-[#1E1E1E] p-3 rounded-lg  w-2/3 md:w-1/3  border-[#FFE11F] border-[0.5px] '>
            <p className='text-center text-white bg-[#C517E6]  h-6 w-6 rounded-full '>1</p>
            <div className='flex flex-col justify-center items-center'>
            <p className='text-center mt-2 mb-1 text-white text-xl'>Lack of Clear Brand Strategy</p>
            <p className='text-center mb-2 w-2/3 text-[#AAAAAA]'>Most designers focus only on visuals, missing the deeper strategy needed for differentiation.</p>
